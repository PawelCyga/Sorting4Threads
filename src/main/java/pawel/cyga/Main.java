...
public class Main {
    public static void main(String[] args) {
        ...
        int threadNumber = 4;//Just for output text
        ...
        int[][] part1 = Arrays.copyOfRange(numbersArray, 0, 4);
        int[][] part2 = Arrays.copyOfRange(numbersArray, 4, 8);
        int[][] part3 = Arrays.copyOfRange(numbersArray, 8, 12);
        int[][] part4 = Arrays.copyOfRange(numbersArray, 12, 16);
